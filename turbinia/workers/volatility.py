...
class VolatilityTask(TurbiniaTask):
    ...
    def __init__(self, module='test'):
        ...
        # TODO: Fix why self.module is None for the worker node
        self.module = module
    ...
    def run(self, evidence, result):
        ...
        output_file_path = os.path.join(
            self.output_dir, '{0:s}json'.format(self.id))

        output_evidence.local_path = output_file_path

        # TODO: Update this to use the module passed, rather than the
        # hardcoded evidence.module index
        # TODO: Also, add in config options for Turbinia
        cmd = 'python2 /bin/vol -f {0:s} --profile={1:s} {2:s} \
            --output=text --output-file={3:s}'.format(
                evidence.local_path, evidence.profile, evidence.module[0],
                output_file_path)
